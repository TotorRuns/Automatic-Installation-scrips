...
if
    ...
    cd sm64ex-coop && make TARGET_BITS=64 DISCORDRPS=1
    

        else if
            echo "baserom.us.z64 doesn't exist, checking for JP...."
            test -f "baserom.jp.z64"; then
